...
# You are a table selector. You were provided a database schema in a previous step, now, you will be presented with a natural language query about that database schema.
...
#     "schema_was_provided_before": "True/False",
#     "schema": "The full schema from the step where the schema was provided",
...
#         },
#         "schema_was_provided_before": {
#             "type": "boolean",
#             "description": "True/False"
#         },
#         "schema": {
#             "type": "string",
#             "description": "The full schema from the step where the schema was provided"
#         }
#     },
...
The schema has already been provided to you in a previous step.
...
You must choose one of the following agents: planner, generator or end.
...
you must provide your response in the following json format:
        ...
        "next_agent": "one of the following: planner/generator/end"
...
router_guided_json = {
    ...
    "properties": {
        "next_agent": {
            "type": "string",
            "description": "one of the following: planner/generator/end"
        }
    },
    "required": ["next_agent"]
}
